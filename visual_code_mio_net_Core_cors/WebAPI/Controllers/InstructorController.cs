...
namespace WebAPI.Controllers
{
    ...
    {
        //anaotacion para quien tendrá acceceso , solo los user que envian el token con el rol admin podrán leer la data
        ...
        //controller endPoint para consumir servicio
        [HttpPost]
        public async Task<ActionResult<Unit>> Crear(Nuevo.Ejecuta data){
            return await Mediator.Send(data);
        }
        //en el endpint pasar un parametro de tipo id, nombre de la variable de guid id
        [HttpPut("{id}")]
